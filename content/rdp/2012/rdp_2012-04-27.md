...
![News.png](https://cdn.geotribu.fr/images/internal/icons-rdp-news/news.png){: .img-rdp-news-thumb }
 Comme chaque semaine, voici votre rendez-vous du Week-End, la revue de presse de GeoTribu. Au menu de celle-ci, vous retrouverez : les [habituelles sorties et nouvelles versions](#sorties), une bonne dose d'[OpenStreetMap](#osm), mais aussi le [rachat de Sketchup par Trimble](#news321), une explication en détail des [cartogrammes](#news32) ou encore un plan du [métro parisien en HTML5](#news3221).
